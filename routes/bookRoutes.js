...
const { recordBook, allBook, singleBook, borrowBook, returnBook, reviewBook, likeBook, updateBook, deleteBook, allBooksByCategories, returnedBooks, confirmReturns, } = require('../controller/bookController')
